...
def generate_advices():
    ...
    if waterLevel < 15:
        advices.append(' Cảnh báo: Lượng nước trong bình đang rất thấp, hãy châm thêm nước!')
    if temp > 32:
        advices.append(' Nhiệt độ môi trường đang quá nóng, hệ thống quạt đang hoạt động hết công suất.')
    if temp < 18:
        advices.append(' Trời đang lạnh, hãy đảm bảo bé cưng ở gần khu vực đèn sưởi.')
